...
import { Banknote, Calculator, PieChart, TrendingUp, FileText } from 'lucide-react';
          ...
          <Paper elevation={0} sx={{ p: 6, border: '1px solid', borderColor: 'divider', maxWidth: 600, width: '100%' }}>
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 3 }}>
              ...
              <Typography variant="body1" color="text.secondary" sx={{ maxWidth: 400 }}>
                We're building a comprehensive accounting system to help you manage your business finances. 
                This will include expense tracking, invoicing, and financial reporting.
              </Typography>
              ...
              <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 2, mt: 2, width: '100%' }}>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, p: 2, bgcolor: 'grey.50', borderRadius: 1 }}>
                  ...
                  <Typography variant="body2" fontWeight={500}>Expense Tracking</Typography>
                </Box>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, p: 2, bgcolor: 'grey.50', borderRadius: 1 }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, p: 2, bgcolor: 'grey.50', borderRadius: 1 }}>
                  ...
                  <Typography variant="body2" fontWeight={500}>Financial Reports</Typography>
                </Box>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, p: 2, bgcolor: 'grey.50', borderRadius: 1 }}>
                  <TrendingUp size={20} color="#0EA5E9" />
                  <Typography variant="body2" fontWeight={500}>Profit Analysis</Typography>
                </Box>
              </Box>
