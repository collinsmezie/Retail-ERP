...
export default function StockoutForm({ defaultProductId, productName }: { defaultProductId?: string; productName?: string }) {
  ...
  const mutation = useMutation({
    mutationFn: async (data: StockoutFormValues) => {
      console.log('StockoutForm mutation called with data:', data);
      ...
      console.log('StockoutForm mutation result:', result);
      return result;
    },
    onSuccess: () => { 
  ...
  const onSubmit = (data: StockoutFormValues) => { 
    console.log('StockoutForm onSubmit called with data:', data);
    setError(''); 
    setNotice(''); 
